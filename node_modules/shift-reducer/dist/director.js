...
var director = {
  ...
  SimpleBlockStatement: function SimpleBlockStatement(reducer, node) {
    var _this4 = this;

    return reducer.reduceSimpleBlockStatement(node, { statements: node.statements.map(function (v) {
        return _this4[v.type](reducer, v);
      }) });
  },
