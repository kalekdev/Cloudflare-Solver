...
export class SimpleBlockStatement {
  type: 'SimpleBlockStatement';
  statements: Array<Statement>;
  constructor(init: Init<SimpleBlockStatement>);
}
