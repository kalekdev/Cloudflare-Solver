...
function brace(rep, id) {
  return new _coderep.Brace(rep, id);
}
...
var MinimalCodeGen = function () {
  ...
  _createClass(MinimalCodeGen, [{
    ...
    value: function reduceBlock(node, _ref18) {
      ...
      return brace(seq.apply(undefined, _toConsumableArray(statements)), _ref18.__cf_ID);
    }
  }, {
      key: 'reduceSimpleBlockStatement',
      value: function reduceSimpleBlockStatement(node, _ref19) {
